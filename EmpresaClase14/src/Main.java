...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Fecha de nacimiento: " + String.valueOf(usuario1.getFechaNacimiento()));
        System.out.println("***************************************************************");
        System.out.println("Nombres: " + usuario2.getNombres());
        System.out.println("RUN: " + usuario2.getRun());
        System.out.println("Fecha de nacimiento: " + String.valueOf(usuario2.getFechaNacimiento()));
        ...
        System.out.println("Hora: " + String.valueOf(capacitacion1.getHora()));
        ...
        System.out.println("Hora: " + String.valueOf(capacitacion2.getHora()));
